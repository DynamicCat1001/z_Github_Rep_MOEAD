...
//        cout<<pop[i].Cost<<endl;
    ...
    Matrix<float, Eigen::Dynamic, 3> Matrix_Cost;
    ...
    {
        cout<<"MOP.MaxIt in MOEAD"<<it<<endl;
        for(int i=0; i<MOP.nPop; ++i)//MOP.nPop
        {
            // cout<<"Reproduction (Crossover)"<<endl;
//            cout<<"MOP nPop_"<< i <<endl;
...
//            cout<<k<<" , IsDominated"<<pop[k].IsDominated<<endl;
        ...
        {
//        cout<<"Elite Pop"<<Elite_Pop.size()<<endl;
            ...
            for(int ff=0; ff<Elite_Pop.size(); ++ff)
            {
    ...
    cout<<": Number of Elite Pareto Solutions ="<<Elite_Pop.size()<<endl;
    return Storage_Cost;
